package top.xmy.requestservice.crawler;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://zh-hans.react.dev/learn";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"__next\"]/div[3]/main/article/div");
